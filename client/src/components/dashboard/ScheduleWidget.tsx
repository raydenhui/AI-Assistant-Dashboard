      ...
      <div className="widget">
        <div className="widget-header">
          <div className="flex items-center gap-2">
            <span className="dark:text-white">Upcoming Schedule</span>
            {events.length > 0 && (
              <span className="text-xs bg-gray-200 text-gray-600 px-2 py-0.5 rounded-full dark:bg-slate-700 dark:text-slate-300">
                {events.length} today
              </span>
            )}
            {lastUpdated && (
